...
public class Ship {
    ...
    private Date prodDate; //Дата выпуск (Диапазон значений года 2800..3019 включительно)

    @Column(name = "isUsed")
    private Boolean isUsed; //Использованный / новый

    @Column(name = "speed")
    private Double speed; //Максимальная скорость корабля(Диапазон значений 0,01..0,99 включительно. Используй математическоеокругление до сотых)
